...
pacman_install waybar awww mako caligula hypridle hyprlock hyprpicker impala bluetui wiremix fuzzel nwg-look polkit-gnome gum ffmpegthumbnailer zenity
